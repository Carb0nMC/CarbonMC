...
public class Database {
    ...
    public boolean openConnection() {
        ...
        try {
            ...
            CarbonMC.get().getLogger().severe("Database driver not found.");
            return false;
        }
        ...
        try {
            ...
            CarbonMC.get().getLogger().severe("An exception occurred when connecting to the database.");
            ex.printStackTrace();
            return false;
        }
        return true;
    ...
    public void closeConnection() {
        if (!isClosed()) {
            try {
                ...
                CarbonMC.get().getLogger().severe("An exception occurred when closing database connection.");
                ex.printStackTrace();
            }
            connection = null;
        }
